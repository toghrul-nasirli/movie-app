...
@section('content')
    <div class="person-info border-b border-gray-800">
        <div class="container flex flex-col md:flex-row mx-auto px-4 py-12">
            <div class="flex-none">
                <img src="https://image.tmdb.org/t/p/w300/mclHxMm8aPlCPKptP67257F5GPo.jpg" alt="Tom Hiddleston" class="rounded-md w-48 md:w-64">
            ...
            <div class="md:ml-24">
                <div class="text-4xl font-semibold mt-2 md:mt-0">Tom Hiddleston</div>
                <div class="flex flex-wrap items-center text-gray-400 text-sm mt-1">
                    ...
                    <span class="ml-2">Born on Feb 20, 1983 (37 years old) in New York city</span>
                </div>

                <p class="text-gray-300 mt-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque nisi blanditiis pariatur eum tempora consequuntur eius reiciendis atque natus in amet tempore vitae ex, error voluptas corrupti vero temporibus sit maxime quidem quia. Officiis quis, cum temporibus maiores aperiam dolorem!</p>
            
                <h4 class="font-semibold mt-12">Known for</h4>
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                    <div class="mt-4">
                        <a href="#">
                            <img src="https://image.tmdb.org/t/p/w150_and_h225_bestv2/kEl2t3OhXc3Zb9FBh1AuYzRTgZp.jpg" alt="poster" class="hover:opacity-75 transition ease-in-out duration-200">
                        </a>
                        <a href="#" class="text-sm leading-normal block text-gray-400 hover:text-white mt-1">Loki</a>
                    </div>
                    <div class="mt-4">
                        <a href="#">
                            <img src="https://image.tmdb.org/t/p/w150_and_h225_bestv2/kEl2t3OhXc3Zb9FBh1AuYzRTgZp.jpg" alt="poster" class="hover:opacity-75 transition ease-in-out duration-200">
    ...
    <div class="credits border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <ul class="list-disc leading-loose pl-5 mt-8">
                <li>2020 <strong>&middot; Movie</strong> as Loki</li>
                <li>2020 <strong>&middot; Movie</strong> as Loki</li>
                <li>2020 <strong>&middot; Movie</strong> as Loki</li>
                <li>2020 <strong>&middot; Movie</strong> as Loki</li>
                <li>2020 <strong>&middot; Movie</strong> as Loki</li>
