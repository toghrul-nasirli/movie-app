...
@section('content')
    <div class="person-info border-b border-gray-800">
        <div class="container flex flex-col md:flex-row mx-auto px-4 py-12">
            <div class="flex-none">
                <img src="{{ $person['profile_path'] }}" alt="{{ $person['name'] }}" class="rounded-md w-48 md:w-64">
                <ul class="flex items-start mt-4">
                    @if ($social['facebook'])
                        <li class="ml-4">
            ...
            <div class="md:ml-24">
                <div class="text-4xl font-semibold mt-2 md:mt-0">{{ $person['name'] }}</div>
                <div class="flex flex-wrap items-center text-gray-400 text-sm mt-1">
                    ...
                    <span class="ml-2">Born on {{ $person['birthday'] }} ({{ $person['age'] }} years old) in {{ $person['place_of_birth'] }}</span>
                </div>
