<div class="relative mt-3 md:mt-0" x-data="{ isOpen: true }" @click.away="isOpen = false" @keydown.escape.window="isOpen = false" @keydown.shift.tab="isOpen = false" @keydown="isOpen = true">
    ...
    <div class="absolute bg-gray-800 rounded text-sm w-64 mt-4 z-10" x-show.transition.opacity="isOpen">
        <ul>
