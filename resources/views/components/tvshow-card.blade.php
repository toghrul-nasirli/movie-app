<div class="mt-8">
    <a href="{{ route('tv-shows.show', $tvShow['id']) }}">
        <img src="{{ $tvShow['poster_path'] }}" alt="{{ $tvShow['name'] }}" class="rounded-md hover:opacity-75 transition ease-in-out duration-200">
    </a>
    <div class="mt-2">
        <a href="{{ route('tv-shows.show', $tvShow['id']) }}" class="text-lg mt-2 hover:text-gray-300">{{ $tvShow['name'] }}</a>
